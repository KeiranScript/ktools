...
def load_and_run_script(script_name):
    """Dynamically load and execute a script by name."""
    ...
    if script_path.exists():
        ...
        try:
            ...
            print(bcolors.FAIL + f"Failed to run {script_name}: {e}" + bcolors.ENDC)
    else:
        print(bcolors.FAIL + f"Script {script_name} does not exist." + bcolors.ENDC)
...
def main():
    ...
    while True:
        ...
        choice = input(bcolors.OKCYAN + "Select a script to run: " + bcolors.ENDC)
        ...
        if choice.isdigit():
            ...
            if choice == 0:
                ...
                load_and_run_script(script_name)
            else:
                print(bcolors.FAIL + "Invalid selection. Please try again." + bcolors.ENDC)
        else:
